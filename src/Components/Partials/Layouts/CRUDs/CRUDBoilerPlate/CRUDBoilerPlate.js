...
import CRUDModalBoilerPlate from './CRUDModalBoilerPlate/CRUDModalBoilerPlate'

import './CRUDBoilerPlate.css'
import AuthContext from '../../../../../Context/AuthContext'

function CRUDBoilerPlate({
    ...
    }, [toggleFetch, api, hasSelect, selectApi, hasSecondSelect, secondSelectApi, employee.token])
    ...
    return (
        ...
        <div className='crud_holder'>
            <CRUDDashboardBoilerplate
                ...
                // textSelectProps
                hasTextSelect={hasTextSelect}
                textSelectName={textSelectName}
...
export default CRUDBoilerPlate